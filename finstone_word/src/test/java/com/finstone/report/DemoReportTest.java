...
import com.finstone.word.WordTemplate;
...
public class DemoReportTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// 读取word模板，必须是docx类型
		File file = new File("D:\\word\\reportTemplate1.docx");
		...
		// 生成文件
		File outputFile = new File("D:\\word\\输出1.docx");// 改成你本地文件所在目录
	...
	private static Map<String, Object> setPicture1() {
		String title = "归集业务情况";
		...
		List<Map<String, Object>> dataList11 = new ArrayList<Map<String, Object>>();
		
		Map<String, Object> data111 = new HashMap<String, Object>();
		data111.put("category", "2017(Q4)");
		data111.put("value", 290000D);
		dataList11.add(data111);
		
		Map<String, Object> data112 = new HashMap<String, Object>();
		data112.put("category", "2018(Q4)");
		data112.put("value", 190000D);
		dataList11.add(data112);
		
		Map<String, Object> data113 = new HashMap<String, Object>();
		...
		List<Map<String, Object>> dataList21 = new ArrayList<Map<String, Object>>();
		
		Map<String, Object> data211 = new HashMap<String, Object>();
		data211.put("category", "2017(Q4)");
		data211.put("value", 170000D);
		dataList21.add(data211);
		
		Map<String, Object> data212 = new HashMap<String, Object>();
		data212.put("category", "2018(Q4)");
		data212.put("value", 0D);
		dataList21.add(data212);
		
		Map<String, Object> data213 = new HashMap<String, Object>();
	...
	private static Map<String, Object> setPicture2() {
		String title = "提取业务情况";
	...
	private static Map<String, Object> setPicture3() {
		String title = "贷款业务情况";
	...
	private static Map<String, Object> setPicture4() {
		String title = "保值增值情况";
	...
	private static Map<String, Object> setPicture5() {
		String title = "资产风险情况";
	...
	private static Map<String, Object> setPicture6() {
	...
	private static Map<String, Object> setPicture7() {
	...
	private static Map<String, Object> setPicture8() {
		String title = "单位性质";
		...
		Map<String, Object> picMap3 = new HashMap<String, Object>();
		...
		Map<String, Object> picMap4 = new HashMap<String, Object>();
		...
		Map<String, Object> picMap5 = new HashMap<String, Object>();
		...
		Map<String,Object> picture8 = new HashMap<String, Object>();
	...
	private static Map<String, Object> setPicture9() {
		String title = "单位经济类型";
		...
		Map<String, Object> picMap6 = new HashMap<String, Object>();
		picMap6.put("key", "国有全资");
		picMap5.put("value", 15.52);
		picMapList.add(picMap5);
		
		Map<String, Object> picMap7 = new HashMap<String, Object>();
		picMap7.put("key", "国有独资(公司)");
		picMap7.put("value", 0);
		picMapList.add(picMap7);
		
		Map<String, Object> picMap8 = new HashMap<String, Object>();
		picMap8.put("key", "国有联营");
		picMap8.put("value", 3);
		picMapList.add(picMap8);
		
		Map<String, Object> picMap9 = new HashMap<String, Object>();
		picMap9.put("key", "外资");
		picMap9.put("value", 0);
		picMapList.add(picMap9);
		
		Map<String, Object> picMap10 = new HashMap<String, Object>();
		picMap10.put("key", "有限责任(公司)");
		picMap10.put("value", 0);
		picMapList.add(picMap10);
		
		Map<String, Object> picMap11 = new HashMap<String, Object>();
		picMap11.put("key", "港、澳、台投资");
		picMap11.put("value", 0);
		picMapList.add(picMap11);
		
		Map<String, Object> picMap12 = new HashMap<String, Object>();
		picMap12.put("key", "港、澳、台投资股份有限(公司)");
		picMap12.put("value", 46.86);
		picMapList.add(picMap12);
		
		Map<String, Object> picMap13 = new HashMap<String, Object>();
		picMap13.put("key", "私有");
		picMap13.put("value", 4);
		picMapList.add(picMap13);
		
		Map<String, Object> picMap14 = new HashMap<String, Object>();
	...
	private static Map<String, Object> setParametersMap() {
	...
	private static List<Map<String, Object>> setTable1() {
	...
	private static List<Map<String, Object>> setTable2() {
	...
	private static List<Map<String, Object>> setTable3() {
	...
	private static List<Map<String, Object>> setTable4() {
		...
		Map<String, Object> map413 = new HashMap<String, Object>();
		map413.put("km", "10102");
		map413.put("kmmc", "定期款");
		map413.put("kmjb", "2");
		map413.put("kmsx", "01");
		...
		Map<String, Object> map414 = new HashMap<String, Object>();
		map414.put("km", "102");
		...
		Map<String, Object> map415 = new HashMap<String, Object>();
		map415.put("km", "10201");
		map415.put("kmmc", "活期");
		map415.put("kmjb", "2");
		map415.put("kmsx", "01");
		...
		Map<String, Object> map416 = new HashMap<String, Object>();
		map416.put("km", "10202");
		map416.put("kmmc", "定期款");
		map416.put("kmjb", "2");
		map416.put("kmsx", "01");
